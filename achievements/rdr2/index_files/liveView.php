...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?schain=1.0,1!network-n.com,pa_bee9082e,1&playerApiId=netw0rkN&cbuster=1670229967246&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Fpsnprofiles.com%2Ftrophies%2F8370-red-dead-redemption-2%2FiSullyMan&s=108267&cbuster=1670230170',
					origQString: 'schain=1.0,1!network-n.com,pa_bee9082e,1&playerApiId=netw0rkN&cbuster=1670229967246&subId=[SUBID_ENCODED]&pubUrl=https%3A%2F%2Fpsnprofiles.com%2Ftrophies%2F8370-red-dead-redemption-2%2FiSullyMan&s=108267',
					placementId: 108267,
					x: 640,
					y: 440,
					videoType: 'flow',
